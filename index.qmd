...
A core principle in assessing the maximum range at which an unmanned aircraft can be visually tracked is the concept of visual acuity, often approximated as the ability to distinguish details that subtend an angle of roughly 1 arc minute (1/60 of a degree, or 00&#176; 01&#8242; 00&#8243;) at the eye. Under standard conditions, an individual with “normal” vision (commonly referred to as 20/20 in the United States) can discern details at this resolution. For an individual with "normal" vision, the letter E on the Snellen Eye Chart (@fig-snellen-chart) on the 20/20 row corresponds to 5 arc minutes (5&#8242;) when viewed at 20 ft. The angle subtended by one stroke of the letter E corresponds to 1 arc minute (1&#8242;) as depicted in @fig-snellen-E. 
...
<svg width="100%" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
    <!-- Letter E -->
    <line x1="50" y1="50" x2="50" y2="150" stroke="black" stroke-width="20"/>
    <line x1="40" y1="50" x2="100" y2="50" stroke="black" stroke-width="20"/>
    <line x1="40" y1="100" x2="90" y2="100" stroke="black" stroke-width="20"/>
    <line x1="40" y1="150" x2="100" y2="150" stroke="black" stroke-width="20"/>
    
    <!-- Extending lines -->
    <line x1="100" y1="43" x2="350" y2="100" stroke="black" stroke-width="3"/>
    <line x1="100" y1="58" x2="350" y2="100" stroke="black" stroke-width="3"/>
    
    <!-- Angle annotation -->
    <path d="M140 50 A50 50 0 0 1 160 52" fill="none" stroke="black"/>
    <text x="165" y="55" font-size="12">1′</text>
</svg>
```
Visualization of 1&#8242;
:::
